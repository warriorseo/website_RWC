...
if target_h2:
    ...
    while start_block.parent != soup.find('div', class_='content-area'):
        start_block = start_block.parent
        
    placeholder_row = start_block.find_next_sibling('div', class_='row')
    ...
    if placeholder_row:
                    ...
                    <table style="width: 100%; border-collapse: collapse; text-align: center; font-size: 1em;">
                        ...
                        <tbody>
                            <tr style="background-color: #f9f9f9;">
                                ...
                                <td style="padding: 15px; border: 1px solid #ddd; color: #25d366; font-weight: bold;">[Mockup: เจ็บน้อยมาก]</td>
                                <td style="padding: 15px; border: 1px solid #ddd; color: #da0000; font-weight: bold;">[Mockup: เจ็บมาก]</td>
                            </tr>
                            <tr>
        ...
        placeholder_row.replace_with(new_soup)
        
        with open(filepath, 'w', encoding='utf-8') as f:
            f.write(soup.prettify())
        print('Injected Table Mockup and restructured layout.')
    else:
        print('Placeholder row not found.')
else:
    print('H2 not found.')
